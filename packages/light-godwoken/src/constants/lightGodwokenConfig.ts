...
const v0ConfigAggron: LightGodwokenConfig = {
  ...
  layer2Config: {
    SCRIPTS: {
      deposit_lock: {
        scriptType_hash: "0x5a2506bb68d81a11dcadad4cb7eae62a17c43c619fe47ac8037bc8ce2dd90360",
        cell_dep: {
          outPoint: {
      ...
      withdrawal_lock: {
        scriptType_hash: "0x170ef156e9f6132dbca6069dfd3e436f7d91c29d3ac7332c4b33e633b6a299b5",
        cell_dep: {
          outPoint: {
      ...
      eth_account_lock: {
        scriptType_hash: "0xdeec13a7b8e100579541384ccaf4b5223733e4a5483c3aec95ddc4c1d5ea5b22",
      },
    },
    ROLLUP_CONFIG: {
...
const v0ConfigLina: LightGodwokenConfig = {
  ...
  layer2Config: {
    SCRIPTS: {
      deposit_lock: {
        scriptType_hash: "0xe24164e2204f998b088920405dece3dcfd5c1fbcb23aecfce4b3d3edf1488897",
        cell_dep: {
          outPoint: {
      ...
      withdrawal_lock: {
        scriptType_hash: "0xf1717ee388b181fcb14352055c00b7ea7cd7c27350ffd1a2dd231e059dde2fed",
        cell_dep: {
          outPoint: {
      ...
      eth_account_lock: {
        scriptType_hash: "0x1563080d175bf8ddd44a48e850cecf0c0b4575835756eb5ffd53ad830931b9f9",
      },
    },
    ROLLUP_CONFIG: {
...
const v1ConfigAggron: LightGodwokenConfig = {
  ...
  layer2Config: {
    SCRIPTS: {
      deposit_lock: {
        scriptType_hash: "0x50704b84ecb4c4b12b43c7acb260ddd69171c21b4c0ba15f3c469b7d143f6f18",
        cell_dep: {
          outPoint: {
      ...
      withdrawal_lock: {
        scriptType_hash: "0x06ae0706bb2d7997d66224741d3ec7c173dbb2854a6d2cf97088796b677269c6",
        cell_dep: {
          outPoint: {
      ...
      eth_account_lock: {
        scriptType_hash: "0x07521d0aa8e66ef441ebc31204d86bb23fc83e9edc58c19dbb1b0ebe64336ec0",
      },
    },
    ROLLUP_CONFIG: {
...
const v1ConfigLina: LightGodwokenConfig = {
  ...
  layer2Config: {
    SCRIPTS: {
      deposit_lock: {
        scriptType_hash: "0xff602581f07667eef54232cce850cbca2c418b3418611c132fca849d1edcd775",
        cell_dep: {
          outPoint: {
      ...
      withdrawal_lock: {
        scriptType_hash: "0x3714af858b8b82b2bb8f13d51f3cffede2dd8d352a6938334bb79e6b845e3658",
        cell_dep: {
          outPoint: {
      ...
      eth_account_lock: {
        scriptType_hash: "0x096df264f38fff07f3acd318995abc2c71ae0e504036fe32bc38d5b6037364d4",
      },
    },
    ROLLUP_CONFIG: {
